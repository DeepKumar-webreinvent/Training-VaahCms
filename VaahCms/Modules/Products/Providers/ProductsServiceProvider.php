<?php namespace VaahCms\Modules\Products\Providers;


use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use VaahCms\Modules\Products\Providers\RouteServiceProvider;
use VaahCms\Modules\Products\Providers\EventServiceProvider;
...
class ProductsServiceProvider extends ServiceProvider
{
    ...
    private function registerMiddleware($router) {
        ...
        //register middleware
        //$router->aliasMiddleware('sample.middleware', \Products\Http\Middleware\SampleMiddleware::class);
    ...
    {
        $viewPath = resource_path('/views/vaahcms/modules/products');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/views/vaahcms/modules/products';
    ...
    public function registerAssets()
    {
        ...
        $desPath = public_path('vaahcms/modules/products/assets');
    ...
    {
        $langPath = resource_path('/lang/vaahcms/modules/products');
